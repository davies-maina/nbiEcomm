  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('images/admin_images/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Nairobae A/Panel</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="#" class="nav-link {{Request::routeIs('settings')? 'active':''}} || {{Request::routeIs('updateadmindata')? 'active':''}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{url('/admin/settings')}}" class="nav-link {{Request::routeIs('settings')? 'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Update password</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="{{url('/admin/update-admin-data')}}" class="nav-link {{Request::routeIs('updateadmindata')? 'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
